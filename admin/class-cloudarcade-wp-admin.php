...
class Cloudarcade_Wp_Admin {
	...
	function get_settings_sections() {
        $sections = array(
            array(
                'id'    => 'cloudarcade_basics_settings',
                'title' => __( 'Basic Settings', CA_TEXTDOMAIN )
            ),
            array(
                'id'    => 'cloudarcade_db_settings',
                'title' => __( 'Games Database Settings', CA_TEXTDOMAIN )
            ),
    ...
    function get_settings_fields() {
        $settings_fields = array(
            'cloudarcade_basics_settings' => array(
           
                array(
                    'name'              => 'posts_number',
                    'label'             => __( 'Number of posts in archive', CA_TEXTDOMAIN ),
            ...
            'cloudarcade_db_settings' => array(
                ...
                array(
                    'name'              => 'db_pass',
                    'label'             => __( 'Database Password', 'wedevs' ),
                    'desc'              => __( '', 'wedevs' ),
                    'placeholder'       => __( '', 'wedevs' ),
                    'type'              => 'text',
                    'default'           => '',
	...
	function cloudarcade_wp_admin_init() {
		if(isset($_POST['cloudarcade_wp_sync']) && check_admin_referer('cloudarcade_wp_sync_action', 'cloudarcade_wp_sync_nonce')) {
